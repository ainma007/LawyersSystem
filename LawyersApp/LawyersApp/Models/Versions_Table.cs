...
namespace LawyersApp.Models
{
    ...
    public partial class Versions_Table
    {
        public int VersionsID { get; set; }
        public string PartnerName { get; set; }
        public string VersionsName { get; set; }
        public Nullable<System.DateTime> VersionsDate { get; set; }
        public Nullable<int> VersionsNumbers { get; set; }
        public Nullable<int> TypesOfCopies { get; set; }
