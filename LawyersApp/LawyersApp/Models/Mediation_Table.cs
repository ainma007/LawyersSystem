...
namespace LawyersApp.Models
{
    ...
    public partial class Mediation_Table
    {
        ...
        public string FirstSideGender { get; set; }
        public Nullable<int> FirstSideAge { get; set; }
        ...
        public Nullable<int> DiligenceTypeID { get; set; }
    
        public virtual DiligenceType_Table DiligenceType_Table { get; set; }
